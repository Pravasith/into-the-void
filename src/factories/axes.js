    ...
    while (c < maxRange + 1) {
        ...
        while (subCY < maxRange + 1) {
            ...
            yGeometry.vertices.push(
                new THREE.Vector3(subCY, -maxRange, reverseC)
            )
            yGeometry.vertices.push(
                new THREE.Vector3(subCY, maxRange, reverseC)
            )
            ...
            yGeometry.vertices.push(
                new THREE.Vector3(subCReverseY, -maxRange, c)
            )
            yGeometry.vertices.push(
                new THREE.Vector3(subCReverseY, maxRange, c)
            )
            yGeometry.vertices.push(
                new THREE.Vector3(subCReverseY, -maxRange, reverseC)
            )
            yGeometry.vertices.push(
                new THREE.Vector3(subCReverseY, maxRange, reverseC)
            )
        ...
        while (subCX < maxRange + 1) {
            ...
            xGeometry.vertices.push(
                new THREE.Vector3(subCX, reverseC, -maxRange)
            )
            xGeometry.vertices.push(
                new THREE.Vector3(subCX, reverseC, maxRange)
            )
            ...
            xGeometry.vertices.push(
                new THREE.Vector3(subCReverseX, c, -maxRange)
            )
            xGeometry.vertices.push(
                new THREE.Vector3(subCReverseX, c, maxRange)
            )
            xGeometry.vertices.push(
                new THREE.Vector3(subCReverseX, reverseC, -maxRange)
            )
            xGeometry.vertices.push(
                new THREE.Vector3(subCReverseX, reverseC, maxRange)
            )
        ...
        while (subCZ < maxRange + 1) {
            ...
            zGeometry.vertices.push(
                new THREE.Vector3(-maxRange, subCZ, reverseC)
            )
            zGeometry.vertices.push(
                new THREE.Vector3(maxRange, subCZ, reverseC)
            )
            ...
            zGeometry.vertices.push(
                new THREE.Vector3(-maxRange, subCReverseZ, c)
            )
            zGeometry.vertices.push(
                new THREE.Vector3(maxRange, subCReverseZ, c)
            )
            zGeometry.vertices.push(
                new THREE.Vector3(-maxRange, subCReverseZ, reverseC)
            )
            zGeometry.vertices.push(
                new THREE.Vector3(maxRange, subCReverseZ, reverseC)
            )
