            ...
            modelData.children.map((item, i) => {
                switch (item.name) {
                    case "Sphere":
                        ...
                        let crystalLight1 = createPointlight(
                                rainbowColors.blue,
                                2
                            ),
                            crystalLight2 = createPointlight(
                                rainbowColors.orange,
                                3
                            ),
                            crystalLight3 = createPointlight(
                                rainbowColors.red,
                                5
                            ),
                            crystalLight4 = createPointlight(
                                rainbowColors.orange,
                                2
                            ),
                            crystalLight5 = createPointlight(
                                rainbowColors.yellow,
                                3
                            ),
                            crystalLight6 = createPointlight(
                                rainbowColors.blue,
                                5
                            )
                ...
                switch (item.name) {
                    ...
                    case "rotor":
                        item.children.filter(
                            item => item.name === "pinkPipe"
                        )[0].material = item.material = cubeMaterial3
                        break
